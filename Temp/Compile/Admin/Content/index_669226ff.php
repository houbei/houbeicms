...
URL = 'http://192.168.1.105/houbeicms/index.php?m=Admin&c=Content&a=index';
...
CONTROLLER = 'http://192.168.1.105/houbeicms/index.php?m=Admin&c=Content';
ACTION = 'http://192.168.1.105/houbeicms/index.php?m=Admin&c=Content&a=index';
...
CONTROLLER_VIEW = 'http://192.168.1.105/houbeicms/HDCMS/Admin/View/Content';
HISTORY = 'http://192.168.1.105/houbeicms/index.php?m=Admin';
</script>
...
<link rel="stylesheet" href="http://192.168.1.105/houbeicms/HDCMS/Admin/View/Content/ztree/css/zTreeStyle/zTreeStyle.css" type="text/css">
<script type="text/javascript" src="http://192.168.1.105/houbeicms/HDCMS/Admin/View/Content/ztree/js/jquery.ztree.all-3.5.min.js"></script>
<style type="text/css">
    div#category_tree{
        font-size:12px;
    }
    ...
    div#move span.left {
        background: url("http://192.168.1.105/houbeicms/HDCMS/Admin/View/Content/img/ico_left.gif") no-repeat;
        left: -10px;
    }

    div#move span.right {
        background: url("http://192.168.1.105/houbeicms/HDCMS/Admin/View/Content/img/ico_right.gif") no-repeat;
        left: 5px;
    }
    ...
    #tree_title span {
        display: block;
        background: url("http://192.168.1.105/houbeicms/HDCMS/Admin/View/Content/ztree/css/zTreeStyle/img/diy/1_open.png");
        width: 15px;
        height: 15px;
        float: left;
        margin-right: 5px;
