...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('1','1','WEBNAME','后备网','网站名称','text','后盾网','','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('2','1','ICP','京ICP备12048441号-3','ICP备案号','text','','','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('3','6','HTML_PATH','h','静态html目录','text','','','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('4','1','COPYRIGHT','Copyright © 2012-2014  开源阿村','网站版权信息','text','','','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('7','1','EMAIL','805567188@qq.com','管理员邮箱','text','','','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('13','5','WATER_ON','0','开启水印','radio','','','90','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('14','1','TEL','18076152799','联系电话','text','','','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('15','5','WATER_TEXT','acun.cc','水印文字','text','','不能使用中文','91','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('34','4','EMAIL_USERNAME','805567188@qq.com','邮箱用户名','text','','使用126或qq邮箱','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('35','4','EMAIL_PASSWORD','xiao5251314668','邮箱密码','text','','邮箱的密码','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('38','4','EMAIL_FROMNAME','李洪海','发送人','text','','发送人发件箱显示的用户名','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('39','4','EMAIL_FORMMAIL','805567188@qq.com','发件人','text','','发送人发件箱显示的邮箱址址','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('40','1','QQ_GROUP','166421499','QQ群','text','','','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES('41','1','WEIBO','http://www.houbei.cc','微博','text','','','100','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
